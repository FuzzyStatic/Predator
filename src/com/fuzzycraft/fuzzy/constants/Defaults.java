...
public class Defaults {
	...
	public static final int EVENT_TIME = 30; // In seconds
	public static final int FINISH_TIME = 15; // In seconds
	public static final int LOBBY_TIME = 30; // In seconds
	public static final int MIN_PLAYERS = 20;
	public static final int MATERIAL_AMOUNT = 20;
	public static final int POINTS_EGG = 5;
	public static final int POINTS_KILL = 1;
	
	public static final String SPAWN_WORLD = "hub";
